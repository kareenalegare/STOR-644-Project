...
For our next steps, we plan on doing some variable and model selection to identify which predictors should be included in our linear model. Then we will fit a linear model and do some hypothesis tests (T-tests and F-tests) to draw a conclusion on our null hypotheses. 
