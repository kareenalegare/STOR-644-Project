...
Pokemon is a Japanese video game where you catch Pokemon in the wild and use them to fight battles against other Pokemon. Pokemon are wild monsters and each one has a type, like fire, water, grass, etc. The type of a Pokemon will affect battle outcomes through a system of strengths and weakness. For example, fire attacks are very effective against grass Pokemon which results in increased damage. Pokemon also have basic stats like HP (Hit Points), attack, defense etc. These stats will also influence a Pokemon's performance The stat we are most interested in is HP which determines how much damage a Pokemon can take before fainting. The dataset we chose has 949 rows and 22 columns with information about the Pokemon's name, height weight, stats, type etc. 
...
We want to answer these questions because it will provide insight into how Pokemon are designed and if there are any patterns in determining a Pokemon's stats. For example, perhaps Pokemon with higher attack or speed might have lower HP indicating that these Pokemon are designed to do high damage quickly. Or perhaps Pokemon with higher defense have higher HP indicating that these Pokemon are designed to last longer and endure more damage. Understanding the relationship between HP and other parameters will allow players to gain a deeper understanding of the game and more effectively strategize their battles.  
